 ...
 * @param Copy_SPIConfig: Pointer to the SPI_Config_t structure containing the configuration parameters.
 * - Number: The SPI instance used for data transmission.
 ...
 * @param Copy_SPIConfig: Pointer to the SPI_Config_t structure containing the configuration parameters.
 * - Number: The SPI instance used for data reception.
 ...
 * @param Copy_SPIConfig: Pointer to the SPI_Config_t structure containing the configuration parameters.
 * - Number: The SPI instance used for DMA transmission.
 * @return uint8_t: Error state:
 * - OK: DMA transmission enabled successfully.
 * - NULL_PTR_ERR: The configuration pointer is NULL.
 */
 ...
 * It assumes the DMA controller is correctly configured beforehand.
 * @param Copy_SPIConfig: Pointer to the SPI_Config_t structure containing the configuration parameters.
 * - Number: The SPI instance used for DMA reception.
 * @return uint8_t: Error state:
 * - OK: DMA reception enabled successfully.
 * - NULL_PTR_ERR: The configuration pointer is NULL.
 */
