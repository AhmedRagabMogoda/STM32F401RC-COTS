...
{
	RCC->PLLCFGR &= ~(PLLSRC_MASK << PLLSRC_PIN_ACCESS); /* Clear PLL source */
	RCC->PLLCFGR |= (CLKType << PLLSRC_PIN_ACCESS);      /* Set PLL source */
	RCC->PLLCFGR &= ~(PLLMUL_MASK);                      /*Clear PLL multiplication factor*/
	RCC->PLLCFGR |= (PLL_MUL & PLLMUL_MASK );            /*Set PLL multiplication factor*/
}
/************************************************************************/
